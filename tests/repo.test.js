// Прокси файлов репозитория /t/<токен>/repo/<путь> (T-private-repo, v1.12.0).
//
...
//     spxload/routehub (raw и jsDelivr) заменены на прокси с токеном
...
test('rewriteRepoLinks: только spxload/routehub и только пути из манифеста', () => {
  ...
  for (const keep of [
    ...
    'https://raw.githubusercontent.com/spxload/routehub/stash-client/routehub.conf',
