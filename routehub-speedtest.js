...
//   именно из-за этого в C-draft-40 сменили proxy-test-url и тест-адрес всех
//   групп. Скрипт замеров тогда остался на старом адресе, и получалось, что
//   метрики снимаются по одному эндпоинту, а решение о выборе узла Loon
//   принимает по другому. Ожидаемый эффект: часть узлов, выглядевших
//   медленными, окажется быстрее — сравнить медианы rtt до и после.
...
// v0.5.1: пинг-пробы на generate_204 (цель групп Loon); med.
